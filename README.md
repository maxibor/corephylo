...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run maxibor/corephylo --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```
